          ...
          <div className="flex   flex-col space-y-8 justify-between">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="inline-flex hover:text-yellow-500 space-x-2 items-center">
                ...
                <a className="" href="mailto:infonty919344@gmail.com">
                  <span>dipanshmalhotra11@gmail.com</span>
                </a>
              </div>
              <div className="inline-flex space-x-2 items-center">
            ...
            <div className="flex space-x-4 text-lg pl-[120px] md:pl-[30px]">
              <a
                className="hover:scale-125  hover:text-yellow-300"
                target="_blank"
                href="https://www.linkedin.com/in/dipansh-mallhotra/"
              >
              ...
              <a
                className="hover:scale-125  hover:text-yellow-300"
                target="_blank"
                href="https://github.com/dipansh17"
              >
              ...
              <form ref={form} action="" className="flex flex-col space-y-4 ">
                <div>
                  ...
                  <input
                    ...
                    className="mt-2 ring-1 ring-gray-300 w-full rounded-md px-4 focus:ring-2 focus:ring-yellow-400 py-2 outline-none"
                  />
                </div>
